...
## Quick Inference
For quick retrosynthesis prediction using the pre-trained model:
...
print(results[['SMILES', 'Score']])
```

**Command line:**
```bash
python Inference.py "CCO" 10
```
...
**Returns:** DataFrame with columns: `SMILES`, `Predicted site`, `Local reaction template`, `Score`
